...
# Set path for file
csvpath = os.path.join('/Users/nmeyer/Downloads/Week 3 - Class 2/M3C2/Activities/WriteNetflix', 'netflix_ratings.csv')

# Specify the file to write to the movie data.
txtpath = os.path.join('/Users/nmeyer/Downloads/Week 3 - Class 2/M3C2/Activities/WriteNetflix', 'netflix_data.txt')
